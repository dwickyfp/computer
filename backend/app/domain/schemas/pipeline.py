...
class PipelineDestinationTableSyncResponse(BaseSchema):
    ...
    catalog_database_name: str | None = Field(
        default=None,
        description="Optional destination namespace override",
    )
...
class TableSyncCreateRequest(BaseSchema):
    ...
    filter_sql: str | None = Field(
        default=None,
        description="Filter conditions encoded as JSON v2",
    )
    primary_key_column_target: str | None = Field(
        default=None,
...
class PipelineResponse(PipelineBase, TimestampSchema):
    ...
    source_id: Optional[int] = Field(default=None, description="ID of the source")
